...
const struct fat_header* fh=(struct fat_header*)mmap(0x700000000000,fsize,
...
for(int i=0;i<DataClusters;i++)
{
  ...
  while(1)
  {
          ...
          struct bitmap_header* bheader=(struct bitmap_header* )header+ClusterSize*cid+DataOffset;
